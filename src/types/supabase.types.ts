    ...
    Functions: {
      ...
      create_today_plan: {
        ...
        Returns: {
          ...
          question_title: string;
          question_is_finished: boolean;
          question_couples_finished: number;
          question_state: string | null;
          test_id: number | null;
          test_title: string | null;
          test_is_finished: boolean;
          test_couples_finished: number | null;
          test_state: string | null;
          game_id: number | null;
          game_title: string | null;
          game_is_finished: boolean;
          game_couples_finished: number | null;
          game_state: string | null;
          exercise_id: number | null;
          exercise_title: string | null;
          exercise_is_finished: boolean;
          exercise_couples_finished: number | null;
          exercise_state: string | null;
          checkup_id: number | null;
          checkup_title: string | null;
          checkup_is_finished: boolean;
          checkup_couples_finished: number | null;
          checkup_state: string | null;
          article_id: number | null;
          article_title: string | null;
          article_is_finished: boolean;
          article_couples_finished: number | null;
