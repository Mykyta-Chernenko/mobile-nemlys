...
//
//   const choices = [
//     { icon: JobFunIcon, slug: 'fun', title: i18n.t('onboarding_job_fun') },
//     { icon: JobHardIcon, slug: 'hard', title: i18n.t('onboarding_job_hard') },
//     { icon: JobIssuesIcon, slug: 'issues', title: i18n.t('onboarding_job_issues') },
//   ];
...
//               }}
//             ></GoBackButton>
//             <Progress current={3} all={7}></Progress>
//           </View>
//           <View
//             style={{
//               flexGrow: 1,
...
//               h1
//             >
//               {i18n.t('onboarding_job_title_first')}
//               <FontText style={{ color: theme.colors.primary }} h1>
//                 {i18n.t('onboarding_job_title_second')}
//               </FontText>
//               {i18n.t('onboarding_job_title_third')}
//             </FontText>
...
//                 <FontText>{i18n.t('onboarding_job_other')}</FontText>
//                 <StyledInput
//                   containerStyle={{ marginTop: '2%', borderWidth: !chosen && other ? 1 : 0 }}
//                   placeholder={i18n.t('onboarding_job_other_placeholder')}
//                   value={other}
