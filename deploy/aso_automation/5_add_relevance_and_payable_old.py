...
FEW_SHOT_EXAMPLES = [
    {
        ...
        "locale": "en-US",
        "keywords": ['free notes', 'notes', 'notas', 'diary', 'sex', 'screen', 'friend', 'teen school', 'ai meetings', 'notetaker', 'microphone',
                     'uni notes', 'work write', 'gather notes', 'transcribe', 'candy crush', 'instagram', 'whisper',
                     'otter', 'novel', 'take down my notes', 'diary work notes', 'nyheter', 'vær', 'нотатки', 'note app', '일기'],
        "output": [
            {"term": "free notes", "relevance": 80, "payable": 10, "locale_language": True, "is_brand": False},
            {"term": "notes", "relevance": 90, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "notas", "relevance": 90, "payable": 50, "locale_language": False, "is_brand": False},
            {"term": "diary", "relevance": 18, "payable": 30, "locale_language": True, "is_brand": False},
            {"term": "sex", "relevance": 0, "payable": 40, "locale_language": True, "is_brand": False},
            {"term": "screen", "relevance": 5, "payable": 40, "locale_language": True, "is_brand": False},
            {"term": "friend", "relevance": 0, "payable": 40, "locale_language": True, "is_brand": False},
            {"term": "teen school", "relevance": 35, "payable": 15, "locale_language": True, "is_brand": False},
            {"term": "ai meetings", "relevance": 85, "payable": 55, "locale_language": True, "is_brand": False},
            {"term": "notetaker", "relevance": 90, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "microphone", "relevance": 80, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "uni notes", "relevance": 85, "payable": 45, "locale_language": True, "is_brand": False},
            {"term": "work write", "relevance": 75, "payable": 70, "locale_language": True, "is_brand": False},
            {"term": "gather notes", "relevance": 85, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "transcribe", "relevance": 90, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "candy crush", "relevance": 5, "payable": 10, "locale_language": True, "is_brand": True},
            {"term": "instagram", "relevance": 5, "payable": 30, "locale_language": True, "is_brand": True},
            {"term": "whisper", "relevance": 70, "payable": 80, "locale_language": True, "is_brand": True},
            {"term": "otter", "relevance": 80, "payable": 80, "locale_language": True, "is_brand": True},
            {"term": "novel", "relevance": 10, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "take down my notes", "relevance": 90, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "diary work notes", "relevance": 70, "payable": 65, "locale_language": True, "is_brand": False},
            {"term": "nyheter", "relevance": 10, "payable": 50, "locale_language": False, "is_brand": False},
            {"term": "vær", "relevance": 5, "payable": 40, "locale_language": False, "is_brand": False},
            {"term": "нотатки", "relevance": 90, "payable": 50, "locale_language": False, "is_brand": False},
            {"term": "note app", "relevance": 90, "payable": 50, "locale_language": True, "is_brand": False},
            {"term": "일기", "relevance": 18, "payable": 30, "locale_language": False, "is_brand": False},
        ]
    },
]
...
2. **payable**: Integer (1-100) indicating how payable the keyword’s audience is. Non-payable terms (e.g., "free", "sex game") should be <20; payable terms (e.g., "trust issues", "business meeting") higher., neutral or indecisive words get 50
3. **locale_language**: Boolean (True/False) indicating if the keyword is in the specified locale’s expected (e.g., "book" is False in es-US, "libro" is True, because language is spanish. for en-CA "guessing" is True, but jeu devinette is False, as it is English in Canada, French is not the locale language in this case).
4. **is_brand**: Boolean (True/False) indicating if the keyword is a brand name (e.g., "Instagram", "cozy couple").
...
["notes"]
Example output:
{{"result": [{{"term": "notes", "relevance": 90, "payable": 70, "locale_language": True, "is_brand": False}}]}}
"""
...
def process_batch(batch, locale, description):
    ...
    for keyword, metrics in zip(batch, response_list):
        ...
        keyword["locale_language"] = metrics["locale_language"]
        keyword["is_brand"] = metrics["is_brand"]
